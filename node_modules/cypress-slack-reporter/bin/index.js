...
var fs = require("fs");
var slacker = require("./slack-alert");
var version;
try {
...
program
    ...
    .option("--report-dir [type]", "mochawesome html test report directory, relative to your package.json", "mochareports")
...
slacker.slackRunner(ciProvider, vcsProvider, reportDirectory, videoDirectory, screenshotDirectory, logger, base);
